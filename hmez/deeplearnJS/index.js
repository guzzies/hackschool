...
//   const matrix = track(deeplearn.Array2D.new([2, 3], [2, 4, 6, 8, 10, 12]));
...
'use strict';
['NDArrayMathGPU', 'Graph', 'Session', 'Array1D', 'Array2D', 'SGDOptimizer', 'InCPUMemoryShuffledInputProviderBuilder', 'CostReduction'].forEach(el => window[el] = deeplearn[el]);
