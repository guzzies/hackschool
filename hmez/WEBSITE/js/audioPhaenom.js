...
function initializePhaenom() {
  ...
  Mousetrap.bind('left', audioPhaenom.jumpBack);
  Mousetrap.bind('right', audioPhaenom.jumpForward);
  Mousetrap.bind('space', audioPhaenom.play);
  Mousetrap.bind('a', audioPhaenom.scrollBackwards);
  Mousetrap.bind('d', audioPhaenom.scrollForwards);
